<?php
/**
 * Auto-generated UNST SVG element for "7"
 *
 * Usage (CakePHP):
 *   echo $this->element('unst-7');
 *
 * Variables:
...
?>
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 12 30" width="12" height="30" shape-rendering="crispEdges" class="unst unst-7 <?= htmlspecialchars($class, ENT_QUOTES) ?>"<?= $attr_str ?>>
  <g>
    <polygon class="7" points="0,9 12,9 12,10 0,10"/>
    <polygon class="7" points="8,10 12,10 12,20 8,20"/>
  </g>
</svg>
