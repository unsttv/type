<?php
/**
 * Auto-generated UNST SVG element for "f"
 *
 * Usage (CakePHP):
 *   echo $this->element('unst-f');
 *
 * Variables:
...
?>
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 12 30" width="12" height="30" shape-rendering="crispEdges" class="unst unst-f <?= htmlspecialchars($class, ENT_QUOTES) ?>"<?= $attr_str ?>>
  <g>
    <polygon class="f" points="4,0 8,0 8,20 4,20"/>
    <polygon class="f" points="4,0 12,0 12,1 4,1"/>
    <polygon class="f" points="4,9 12,9 12,10 4,10"/>
  </g>
</svg>
