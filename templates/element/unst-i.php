<?php
/**
 * Auto-generated UNST SVG element for "i"
 *
 * Usage (CakePHP):
 *   echo $this->element('unst-i');
 *
 * Variables:
...
?>
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 12 30" width="12" height="30" shape-rendering="crispEdges" class="unst unst-i <?= htmlspecialchars($class, ENT_QUOTES) ?>"<?= $attr_str ?>>
  <g>
    <polygon class="i" points="4,9 8,9 8,20 4,20"/>
    <polygon class="i" points="4,0 8,0 8,4 4,4"/>
  </g>
</svg>
