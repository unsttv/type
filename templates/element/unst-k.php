<?php
/**
 * Auto-generated UNST SVG element for "k"
 *
 * Usage (CakePHP):
 *   echo $this->element('unst-k');
 *
 * Variables:
...
?>
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 12 30" width="12" height="30" shape-rendering="crispEdges" class="unst unst-k <?= htmlspecialchars($class, ENT_QUOTES) ?>"<?= $attr_str ?>>
  <g>
