<?php
/**
 * Auto-generated UNST SVG element for "n"
 *
 * Usage (CakePHP):
 *   echo $this->element('unst-n');
 *
 * Variables:
...
?>
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 12 30" width="12" height="30" shape-rendering="crispEdges" class="unst unst-n <?= htmlspecialchars($class, ENT_QUOTES) ?>"<?= $attr_str ?>>
  <g>
    <polygon class="n" points="0,9 4,9 4,20 0,20"/>
    <polygon class="n" points="0,9 12,9 12,10 0,10"/>
    <polygon class="n" points="8,10 12,10 12,20 8,20"/>
  </g>
</svg>
