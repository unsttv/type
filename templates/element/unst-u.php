<?php
/**
 * Auto-generated UNST SVG element for "u"
 *
 * Usage (CakePHP):
 *   echo $this->element('unst-u');
 *
 * Variables:
...
?>
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 12 30" width="12" height="30" shape-rendering="crispEdges" class="unst unst-u <?= htmlspecialchars($class, ENT_QUOTES) ?>"<?= $attr_str ?>>
  <g>
    <polygon class="u" points="0,9 4,9 4,20 0,20"/>
    <polygon class="u" points="8,9 12,9 12,20 8,20"/>
    <polygon class="u" points="0,19 12,19 12,20 0,20"/>
  </g>
</svg>
