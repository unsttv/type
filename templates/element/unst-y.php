<?php
/**
 * Auto-generated UNST SVG element for "y"
 *
 * Usage (CakePHP):
 *   echo $this->element('unst-y');
 *
 * Variables:
...
?>
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 12 30" width="12" height="30" shape-rendering="crispEdges" class="unst unst-y <?= htmlspecialchars($class, ENT_QUOTES) ?>"<?= $attr_str ?>>
  <g>
    <polygon class="y" points="0,9 4,9 4,20 0,20"/>
    <polygon class="y" points="8,9 12,9 12,30 8,30"/>
    <polygon class="y" points="0,19 12,19 12,20 0,20"/>
  </g>
</svg>
